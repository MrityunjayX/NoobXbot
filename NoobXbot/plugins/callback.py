...
from NoobXbot import app, BOT_USERNAME, dbb, SUDOERS
import os
import yt_dlp
...
from NoobXbot.NoobXUtilities.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup)
import requests
from pyrogram.types import (
    CallbackQuery,
    InlineKeyboardButton,
...
async def pausevc(_, CallbackQuery):
    ...
    if await is_active_chat(chat_id):
        ...
        await CallbackQuery.answer(f"Nothing is playing on music!", show_alert=True)
